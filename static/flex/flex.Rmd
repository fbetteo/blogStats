...
*  Shot data by player and position on the court can be expressed as groups of players having different shot           patterns. NNMF gives us that. To the left we have the 15 different patterns discovered in the data. Below how much each player shoots from each of them.
